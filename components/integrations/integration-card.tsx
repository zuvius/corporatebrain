...
import { Loader2, RefreshCw, Plug, Unplug, CheckCircle, AlertCircle, Plus } from "lucide-react";
        ...
        {!isFileUpload && (
          <div
            className={cn(
              ...
              status === "connected" && "bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 dark:from-green-900/50 dark:to-emerald-900/50 dark:text-green-200 border border-green-200 dark:border-green-700",
              status === "disconnected" && "bg-gradient-to-r from-gray-100 to-slate-100 text-gray-700 dark:from-gray-800 dark:to-slate-800 dark:text-gray-300 border border-gray-200 dark:border-gray-700",
              status === "error" && "bg-gradient-to-r from-red-100 to-rose-100 text-red-800 dark:from-red-900/50 dark:to-rose-900/50 dark:text-red-200 border border-red-200 dark:border-red-700"
            )}
          >
            ...
            <>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="relative">{isSyncing ? 'Syncing...' : 'Sync Now'}</span>
                </button>
                {/* Tooltip */}
                {showTooltip === 'sync' && (
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 bg-gray-900 text-white text-xs rounded-lg shadow-xl whitespace-nowrap animate-in fade-in zoom-in-95 duration-200">
