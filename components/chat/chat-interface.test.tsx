...
vi.mock('./citation-sidebar', () => ({
  CitationSidebar: () => <div data-testid="citation-sidebar">CitationSidebar</div>,
}));
...
describe('ChatInterface', () => {
  ...
  it('renders welcome message when no messages', () => {
    ...
    expect(screen.getByText('Ask anything about your company knowledge')).toBeInTheDocument();
  });
