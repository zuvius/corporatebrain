...
_Goal: Make the product actually function_
...
_Goal: Enable knowledge ingestion and management_
...
_Goal: Actually pull data from connected services_
...
_Goal: Full-featured chat with history and citations_
...
_Goal: Complete admin dashboard with real functionality_
...
const navItems =
  session.user.role === "admin" ? [...commonItems, ...adminItems] : commonItems;
```
...
_Plan Status: Realistic and Executable_  
_Next Step: Start Phase 1, Day 1 - Fix ChatInterface_  
