...
export const settings = pgTable(
  ...
  (table) => ({
    categoryKeyIdx: index("settings_cat_key_idx").on(
      table.tenantId,
      table.category,
      table.key,
    ),
...
_Document Status: Requirements Definition Complete_  
_Next Step: Implementation Planning & Execution_  
_Estimated Effort: 6-8 weeks (1 developer)_
