...
test.describe('Authentication', () => {
  ...
  test.describe('Protected Routes', () => {
    test('redirects to signin when accessing /app without auth', async ({ page }) => {
      await page.goto('/app');
      
      await expect(page).toHaveURL(/auth/);
    });

    test('redirects to signin when accessing /admin without auth', async ({ page }) => {
      await page.goto('/admin');
      
      await expect(page).toHaveURL(/auth/);
    });

    test('redirects to signin when accessing /integrations without auth', async ({ page }) => {
