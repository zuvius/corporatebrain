import { pgTable, uuid, varchar, text, timestamp, jsonb, index, boolean, integer, real, vector } from "drizzle-orm/pg-core";
...
export const knowledgeSources = pgTable("knowledge_sources", {
  ...
  vectorIdx: index("ks_vector_idx").using("hnsw", table.embedding.op("vector_cosine_ops")),
}));
...
export const conversations = pgTable("conversations", {
  ...
  tenantUserIdx: index("conv_tenant_user_idx").on(table.tenantId, table.userId),
...
export const integrations = pgTable("integrations", {
  ...
  tenantProviderIdx: index("int_tenant_provider_idx").on(table.tenantId, table.provider),
}));
