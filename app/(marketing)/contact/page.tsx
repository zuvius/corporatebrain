...
const inquiryTypes = [
  ...
  },
  {
    ...
    icon: Building2,
    description: "Schedule a custom demo",
  },
  {
    value: "partners",
  ...
  },
  {
    ...
    icon: Users,
    description: "Get team training support",
  },
  {
    value: "bug",
    label: "Report a Bug",
      ...
      <section className="relative overflow-hidden py-20 lg:py-28">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="text-lg text-white/50 max-w-2xl mx-auto">
            Have questions about Corporate Brain? Our team is ready to assist
            ...
            <div>
              ...
              <div className="relative rounded-2xl border border-white/10 bg-white/[0.02] p-6">
                ...
                <div className="relative">
                  ...
                  <a
                    href="mailto:enterprise@corporatebrain.com"
