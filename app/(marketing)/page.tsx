          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-white/50 leading-relaxed mb-8 max-w-xl">
                Corporate Brain connects your docs, conversations, and knowledge
                into one intelligent system. Ask questions, get cited answers,
                automate workflows.
              </p>
              ...
              <div className="mt-12 flex items-center gap-8">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="h-10 w-10 rounded-full border-2 border-[#0a0a0f] bg-gradient-to-br from-violet-500 to-fuchsia-500"
                    />
                  ))}
                </div>
                <div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-white/50">
                            Found 3 relevant docs about Q4 planning from your
                            Slack conversations
                          </p>
                        </div>
                      </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/50 max-w-2xl mx-auto">
              Critical answers trapped across Slack threads, Notion docs,
              emails, and files. Corporate Brain unifies it all.
            </p>
          </div>
          ...
          <div className="relative mb-20">
            ...
            <div className="absolute top-[60px] left-[calc(50%-144px)] right-[calc(50%-144px)] hidden lg:block">
              ...
              <div className="absolute inset-0 overflow-hidden">
                <div
                  className="absolute inset-0 border-t-2 border-dashed border-transparent bg-gradient-to-r from-transparent via-violet-400 to-transparent animate-[shimmer_2s_linear_infinite]"
            ...
            <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
              ...
              <div className="relative">
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="relative mb-6">
                    ...
                    <div
                      className="absolute -right-3 top-1/2 -translate-y-1/2 w-2.5 h-2.5 rounded-full bg-orange-400 shadow-[0_0_10px_rgba(251,146,60,0.8)] hidden lg:block animate-bounce"
              ...
              <div className="relative">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-white/50 leading-relaxed max-w-xs">
                    <span className="text-violet-400 font-semibold">47%</span>{" "}
              ...
              <div className="relative">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-white/50 leading-relaxed max-w-xs">
                    Generic AI answers lack{" "}
                    <span className="text-rose-400 font-semibold">context</span>{" "}
          ...
          <div className="relative max-w-5xl mx-auto bg-[#0f0f1a]/80 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-white/10 shadow-2xl shadow-black/50">
            <div className="flex flex-wrap justify-center items-center gap-4 lg:gap-6">
              ...
              <AppIcon
                icon={<GoogleDriveSVG className="h-5 w-5" />}
              ...
              <div className="relative flex items-center justify-center w-32 h-32 mx-2">
                ...
                <span
                  className="absolute inline-flex h-full w-full rounded-full bg-violet-400 opacity-75 animate-ping"
                  style={{ animationDuration: "2s" }}
                />
                <span
                  className="absolute inline-flex h-[90%] w-[90%] rounded-full bg-fuchsia-400 opacity-60 animate-ping"
                  style={{ animationDuration: "2s", animationDelay: "0.3s" }}
                />
                <span
                  className="absolute inline-flex h-[80%] w-[80%] rounded-full bg-violet-500 opacity-50 animate-ping"
                ...
                <div className="relative w-16 h-16 flex items-center justify-center">
                  ...
                  <div
                    className="absolute inset-0 rounded-full border-2 border-violet-300 opacity-40 animate-pulse"
                    style={{ animationDuration: "1.5s" }}
                  />
                  <div
                    className="absolute -inset-2 rounded-full border border-fuchsia-300 opacity-30 animate-pulse"
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div
                      className="w-3 h-3 rounded-full bg-white shadow-[0_0_20px_rgba(255,255,255,1),0_0_40px_rgba(232,121,249,1)] animate-ping"
                      style={{ animationDuration: "1.5s" }}
                    />
                  </div>
                </div>
              ...
              <div className="relative">
                <AppIcon
                  ...
                  color="from-emerald-500/30 to-green-500/30 border-2 border-emerald-400/50"
                  label="Answer"
                />
      ...
      <section className="border-y border-gray-200 py-12 bg-gradient-to-r from-neutral-50 to-cyan-50">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12">
            {["Google", "Microsoft", "Amazon", "Meta", "Netflix", "Airbnb"].map(
              (company) => (
                <span
                  key={company}
                  className="text-lg font-semibold text-black/40 hover:text-black/70 transition-colors"
                >
                  {company}
                </span>
              ),
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="text-lg lg:text-xl text-white/70 max-w-2xl mx-auto mb-10">
            Connect your apps. Ask questions. Get answers with sources. It's
            that simple.
          </p>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 border border-violet-500/20 rounded-2xl rounded-tl-sm px-4 py-3 max-w-[90%]">
                        <p className="text-white/90 text-sm mb-3">
                          Your Q3 marketing budget is{" "}
                          <span className="text-violet-400 font-semibold">
                            $450,000
                          </span>
                          , approved by Sarah Chen on June 15th. Here's the
                          breakdown:
                        </p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              One platform that connects your entire knowledge stack and makes
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            <StatCard
              ...
              description="vs traditional search"
            />
            <StatCard
              value="50+"
              label="Integrations"
      ...
      <section className="py-24 lg:py-32 relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="text-lg text-white/50 mb-10 max-w-2xl mx-auto">
            Join thousands of teams who find answers faster, make better
            decisions, and unlock their collective knowledge.
          </p>
...
function FeatureCard({
  ...
  return (
    <div className="group relative rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-md transition-all p-6">
      <div
        className={`inline-flex items-center justify-center rounded-xl bg-gradient-to-br ${gradient} p-3 mb-4`}
      >
...
function GoogleDriveSVG({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path
        d="M7.71 2.29L1.71 12.29C1.32 12.88 1.32 13.64 1.71 14.23L5.29 20.41C5.68 21 6.36 21.38 7.07 21.38H16.93C17.64 21.38 18.32 21 18.71 20.41L22.29 14.23C22.68 13.64 22.68 12.88 22.29 12.29L16.29 2.29C15.9 1.71 15.22 1.32 14.5 1.32H9.5C8.78 1.32 8.1 1.71 7.71 2.29Z"
        fill="#0066DA"
      />
      <path
        d="M22.29 14.23L18.71 20.41C18.32 21 17.64 21.38 16.93 21.38H7.07C6.36 21.38 5.68 21 5.29 20.41L1.71 14.23L8.67 14.23L11.33 18.84L14 14.23H22.29Z"
        fill="#00AC47"
      />
      <path
        d="M22.29 14.23L16.29 2.29C15.9 1.71 15.22 1.32 14.5 1.32H9.5C8.78 1.32 8.1 1.71 7.71 2.29L1.71 14.23H8.67L11.33 9.61L14 14.23H22.29Z"
        fill="#2684FC"
      />
      <path
        d="M11.33 9.61L8.67 14.23L1.71 14.23C1.32 13.64 1.32 12.88 1.71 12.29L7.71 2.29C8.1 1.71 8.78 1.32 9.5 1.32H14.5C15.22 1.32 15.9 1.71 16.29 2.29L11.33 9.61Z"
        fill="#EA4335"
      />
    </svg>
  );
