...
import { ArrowRight, Sparkles, Target, Shield, Users, Quote } from "lucide-react";
    ...
    <div className="bg-[#0a0a0f]">
        ...
        <section className="relative overflow-hidden py-20 lg:py-28">
          ...
          <div className="relative mx-auto max-w-4xl px-6 text-center">
            ...
            <p className="text-lg text-white/50 max-w-2xl mx-auto">
              Corporate Brain was founded in 2025 with a simple mission: make company knowledge
              accessible, actionable, and intelligent.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div>
                ...
                <p className="text-white/50 mb-6 leading-relaxed">
                  Every company sits on a goldmine of knowledge trapped in documents, messages,
                  and emails. Yet finding the right information when you need it is frustratingly hard.
                </p>
                <p className="text-white/50 mb-6 leading-relaxed">
                  We believe AI can change this. Not by replacing human expertise, but by making
                  it instantly accessible. Corporate Brain connects to your existing tools,
                  understands your company's unique context, and delivers answers with sources
                  you can trust.
                </p>
                <p className="text-white/50 leading-relaxed">
                  Our goal is simple: help every team member make better decisions, faster.
                </p>
              </div>
              <div className="relative rounded-2xl border border-white/10 bg-white/[0.02] p-8">
                ...
                <div className="relative">
                  ...
                  <blockquote className="text-lg italic text-white/80 mb-4">
                    "The best time to organize your company knowledge was when you started.
                    The second best time is now."
                  </blockquote>
                  <p className="text-sm text-violet-400">— Corporate Brain Team</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative py-20 border-y border-white/5">
          ...
          <div className="relative mx-auto max-w-7xl px-6">
            <h2 className="text-3xl lg:text-4xl font-bold text-white text-center mb-12">Our Values</h2>
        ...
        <section className="relative py-20 border-y border-white/5">
          <div className="absolute inset-0 bg-gradient-to-r from-violet-900/10 via-transparent to-fuchsia-900/10" />
          <div className="relative mx-auto max-w-7xl px-6">
            <h2 className="text-3xl lg:text-4xl font-bold text-white text-center mb-4">Meet Our Team</h2>
            <p className="text-white/50 text-center max-w-2xl mx-auto mb-12">
              ...
              making knowledge work for everyone.
            </p>
            <div className="grid md:grid-cols-3 gap-8">
              <TeamMember name="Sarah Chen" role="CEO & Co-Founder" bio="Former product lead at Google. 10+ years in enterprise SaaS." />
              <TeamMember name="Marcus Johnson" role="CTO & Co-Founder" bio="PhD in ML from MIT. Built AI systems at OpenAI and Anthropic." />
              <TeamMember name="Elena Rodriguez" role="Head of Design" bio="Previously led design at Notion. Focused on intuitive AI interfaces." />
            </div>
          </div>
        </section>
        ...
        <section className="relative py-20 lg:py-28">
          ...
          <div className="relative mx-auto max-w-4xl px-6 text-center">
            ...
            <p className="text-lg text-white/50 mb-8 max-w-xl mx-auto">
              We're always looking for talented people who share our vision for the future of work.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/careers" className="flex items-center gap-2 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 px-8 py-4 text-white font-semibold hover:opacity-90 transition-opacity">
                View Open Positions
                <ArrowRight className="h-4 w-4" />
              </Link>
              <Link href="/contact" className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-8 py-4 text-white font-semibold hover:bg-white/10 transition-colors">
                Contact Us
              </Link>
            </div>
          </div>
